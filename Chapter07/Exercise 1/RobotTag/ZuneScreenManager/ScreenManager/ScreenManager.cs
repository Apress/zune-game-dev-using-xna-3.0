...
namespace ZuneScreenManager
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        /// <summary>
        /// New method for this class. Inits the texture and font to use
        /// </summary>
        /// <param name="gameFont"></param>
        /// <param name="blankTex"></param>
        public void InitializeRequiredContent(SpriteFont gameFont, Texture2D blankTex)
        {
            font = gameFont;
            blankTexture = blankTex;
        }

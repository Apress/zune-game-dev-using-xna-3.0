...
namespace MonkeyFeeder
{
    ...
    public class MonkeyFeederGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Grab the storage device
            Guide.BeginShowStorageDeviceSelector(this.GetStorageDevice, new object());
        }
        ...
        private void SetGameState(GameState state)
        {
            ...
            switch (state)
            {
                ...
                case GameState.GameOver:
                    ...
                    #region Storage Device
                    
                    StorageContainer container = storageDevice.OpenContainer("MonkeyFeeder");
                    string filename = Path.Combine(container.Path, "highscore.dat");
                    ...
                    if (file.Length > 0)
                    {
                        oldScore = int.Parse(reader.ReadLine());
                    }
                    reader.Close();                               
